...
const checkVideo = (videoUrl) => {
  ...
  for (const iframe of iframes) {
    if (iframe.src === videoUrl) return true; // Agar video URL mavjud bo'lsa, true qaytaradi
  }
  return false; // Video mavjud bo'lmasa, false qaytaradi
};
...
const addVideo = () => {
  ...
  videoBox.innerHTML = `<iframe width="100%" height="200" src="${convertYouTubeUrl(videoUrl)}" frameborder="0" allowfullscreen></iframe>`;
